...
import serializer.ClientDAOSerializer;

import javax.persistence.*;

@Entity
@Table(name = "client", schema = "public", catalog = "lo54")
@JsonAdapter(ClientDAOSerializer.class)
public class ClientDAO {
    ...
    private CourseSessionDAO courseSession;
    ...
    public CourseSessionDAO getCourseSession() {
        return courseSession;
    }

    public void setCourseSession(CourseSessionDAO courseSession) {
